...
assert calcChecksum(data_test) == 18
assert calcChecksum2(data_test2) == 9
...
print('part one result:', calcChecksum(data))
print('part two result:', calcChecksum2(data))
