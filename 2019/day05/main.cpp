...
int main(){
	...
	while (running) {
		...
		{
			case ADD: {
				std::cout << "pc:" << pc <<  " cmd:" << input[pc++] << " add addr:" << input[pc++] << " <== " << input[input[pc++]] << " + " << input[input[pc++]] << std::endl;
				break;
			}
			case MULTIPLY: {
				std::cout << "pc:" << pc << " cmd:" << input[pc++] << " mul addr:" << input[pc++] << " <== " << input[input[pc++]] << " * " << input[input[pc++]] << std::endl;
				break;
			}
			case STORE: {
				std::cout << "pc:" << pc << " cmd:" << input[pc++] << " store value:" << input[pc++] << std::endl;
				break;
			}
			case 99: {
				running = false;
	...
	//	if(instruction == ADD || instruction == MULTIPLY || instruction == STORE){
	//		std::cout << std::endl;
	//	}
